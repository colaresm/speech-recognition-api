...
def register_speaker_service(mean, std, inv_C,speaker_id,image_base64):
    speaker_repository.register_speaker( mean, std, inv_C,speaker_id,image_base64)
...
def identify_speaker(path):
    ...
    best_speaker = None
    best_speaker,profile_picture = speaker_repository.identify_speaker(X_mfcc)
