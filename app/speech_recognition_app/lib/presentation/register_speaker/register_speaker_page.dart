...
import 'package:speech_recognition_app/widgets/register_speaker_form.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

typedef _Fn = void Function();

class RegisterSpeakerPage extends StatefulWidget {
  const RegisterSpeakerPage({super.key});

  @override
  State<RegisterSpeakerPage> createState() => _RegisterSpeakerPageState();
}

class _RegisterSpeakerPageState extends State<RegisterSpeakerPage> {
